        ...
        return (
            ...
            est, qui dolorem ipsum quia dolor sit amet, consectetur</p>
                                <ul className="contact-list">
                                    <li> <i className="fa fa-map-marker" aria-hidden="true" /> Lien Chieu, Da Nang</li>
                                    <li><i className="fa fa-envelope" aria-hidden="true" /><Link to="/gmail.com">lexuanmanh101199@gmail.com</Link></li>
                                    <li> <i className="fa fa-phone" aria-hidden="true" />+84 822521380</li>
                                </ul>
                                <div id="container">
                                    {/*Horizontal Tab*/}
                                        ...
                                        <div className="resp-tabs-container hor_1">
                                            <div>
                                                <form action="#" method="post">
                                                    ...
                                                    <input type="submit" defaultValue="Submit" value="Sent"/>
                                                </form>
                                            </div>
